...
import com.lf.cameralibrary.util.AngleUtil;
import com.lf.cameralibrary.util.CameraParamUtil;
import com.lf.cameralibrary.util.CheckPermission;
import com.lf.cameralibrary.util.DeviceUtil;
import com.lf.cameralibrary.util.FileUtil;
import com.lf.cameralibrary.util.LogUtil;
import com.lf.cameralibrary.util.ScreenUtils;
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                if (callback != null) {
                    if (nowAngle == 90 || nowAngle == 270) {
                        ...
                        callback.captureResult(bitmap, path, false);
                    }
                }
            }
        });
